...
async def error_command(client: Client, message: Message):
    ...
    if message.reply_to_message:
        ...
        await client.send_sticker(chat_id, sticker="CAACAgIAAxkBAAEMVH5mHRcyXlLOmrLnBisEBYDIu1F3wgACtCMAAphLKUjeub7NKlvk2TQE", reply_to_message_id=message.reply_to_message.id)
    else:
